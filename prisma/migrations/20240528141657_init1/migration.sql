/*
  ...
  - You are about to drop the column `categoryNam` on the `Interest` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Interest_categoryNam_key";

-- AlterTable
ALTER TABLE "Interest" DROP COLUMN "categoryNam",
